...
public:
	CCefAppEx();
	//自定义
	void	SetJsCallback(CJsInitCallback* pCallback) { m_pJsCallback = pCallback; }
	// CefApp methods:
...
class CCefDOMEventListener: public CefDOMEventListener
{
public:
	CCefDOMEventListener()
	{
